...
int main()
{
    ...
    else
    {
        ...
        do {
            ...
            // X = cos(teta[0])*(L3*cos(teta[1] + teta[2]) + L2*cos(teta[1]) + L4*cos(teta[1] + teta[2] + teta[3]));
 
            // Y = -cos(teta[0]), sin(teta[0])*(L3*cos(teta[1] + teta[2]) + L2*cos(teta[1]) + L4*cos(teta[1] + teta[2] + teta[3]));
 
            // Z = L1 + L3*sin(teta[1] + teta[2]) + L2*sin(teta[1]) + L4*sin(teta[1] + teta[2] + teta[3]);
            ...
            if (c == 'q') {
                ...
                pos = SenseBas;
                angSenseBas = (SenseBasAux - 636) * 0.1041667;
                ...
                pos = SenseElb;
                angSenseElb = (2256 - SenseElbAux) * 0.1209677;
                ...
                pos = SenseWri;
                angSenseWri = (SenseWriAux - 584) * 0.0982533;
