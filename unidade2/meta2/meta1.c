...
void calc_direta(){
    ...
    X = cos(teta[1])*(L3*cos(teta[2] + teta[3]) + L2*cos(teta[2]) + L4*cos(teta[2] + teta[3] + teta[4]));

    Y = sin(teta[1])*(L3*cos(teta[2] + teta[3]) + L2*cos(teta[2]) + L4*cos(teta[2] + teta[3] + teta[4]));

    Z = L1 + L3*sin(teta[2] + teta[3]) + L2*sin(teta[2]) + L4*sin(teta[2] + teta[3] + teta[4]);
}
