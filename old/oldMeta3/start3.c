...
#define HOME_POS "#0P1640T2000#1P1468T2000#2P1672T2000#3P1500T2000#4P1500T2000"
#define POS1 "#0P1640T2000#1P1468T2000#2P1672T2000#3P1500T2000#4P1500T2000"
#define POS2 "#0P1640T2000#1P1468T2000#2P1672T2000#3P1500T2000#4P1500T2000"
#define POS3 "#0P1640T2000#1P1468T2000#2P1672T2000#3P1500T2000#4P1500T2000"
#define POS4 "#0P1640T2000#1P1468T2000#2P1672T2000#3P1500T2000#4P1500T2000"
#define POS5 "#0P1640T2000#1P1468T2000#2P1672T2000#3P1500T2000#4P1500T2000"
#define POS6 "#0P1640T2000#1P1468T2000#2P1672T2000#3P1500T2000#4P1500T2000"
	...
	else
	{
		...
		do {
			...
			if (c == 'q') {
				...
				/* print some text */
				fprintf(f2, "#0P%uT1000#1P%uT1000#2P%uT1000#3P%uT1000#4P%uT1000#5P%uT1000", (unsigned int)SenseBas, (unsigned int)SenseShl, (unsigned int)SenseElb, (unsigned int)SenseWri, (unsigned int)SenseGri);
				fclose(f2);
			} else if (c == '1') {
